...
function msg(message) {
    return "Sequelize Error: ".concat(message);
}
function ExpressErrorSequelize(err, req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var errors, errorMessage, dataError;
        return __generator(this, function (_a) {
            if (err instanceof sequelize_1.BaseError) {
                ...
                if (err instanceof sequelize_1.ValidationError) {
                    ...
                    errors = (0, lodash_1.get)(err, 'errors', []);
                    errorMessage = (0, lodash_1.get)(errors, '0.message', '');
                    switch (errorMessage) {
                    ...
                    dataError = {
                        ...
                        errors: errors.reduce(function (acc, curVal) {
                            acc[curVal.path] = curVal.message;
                            return acc;
                        }, {}),
                    };
                    console.log(dataError.message, dataError.errors);
                    return [2 /*return*/, res.status(400).json(dataError)];
                }
